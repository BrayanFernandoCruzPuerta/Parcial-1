...
class MLQ:
    ...
    def cargarProcesos(self, archivo):
        ...
        :param archivo: Nombre del archivo que contiene los procesos.
        """
        with open(archivo, 'r') as f:
            for linea in f:
                ...
                self.procesos.append(proceso)  # Agregar proceso a la lista.
                self.colas[proceso.queue].append(proceso)  # Añadir proceso a su cola correspondiente.

    def ejecutar(self):
        """
        Ejecuta el algoritmo MLQ usando Round Robin y FCFS según la cola.
        :return: Lista de procesos terminados con sus métricas actualizadas.
        """
        procesosTerminados = []  # Lista para almacenar los procesos que han terminado.
        
        # Mientras haya procesos en las colas.
        while any(self.colas.values()):
            # Iterar sobre cada cola.
            for q, cola in self.colas.items():
                ...
                if proceso.responseTime == -1:
                    proceso.responseTime = self.currentTime - proceso.arrivalTime
